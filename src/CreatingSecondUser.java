...
public class CreatingSecondUser {
	...
	public static void main(String[] args) {
		 ...
		 //Email
		 driver.findElement(By.xpath("//*[@id=\"email_create\"]")).sendKeys("karim10101@gmail.com"); 
		 ...
		 //Information
		  ...
		  driver.findElement(By.xpath("//*[@id=\"customer_firstname\"]")).sendKeys("Karim"); 
		 ...
		 // date
		  ...
		  driver.findElement(By.xpath("//*[@id=\"company\"]")).sendKeys("KU limited"); 
		  driver.findElement(By.xpath("//*[@id=\"address1\"]")).sendKeys("Alabama"); 
		 
		  driver.findElement(By.xpath("//*[@id=\"address2\"]")).sendKeys("House 3"); 
